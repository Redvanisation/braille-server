...
var sttAuthService = new AuthorizationV1(
  Object.assign(
    {
      username: '4dfb6886-743a-4ed8-9668-a10c06ad8020', // or hard-code credentials here
      password: 'dEHZdox2gDlt'
...
app.listen(port, function() {
  console.log('`Example IBM Watson Speech JS SDK client app & token server live at ${process.env.PORT}`', port);
});
